...
import pregnancyImage from "/dogum_takip.jpg";
...
const PregnancyFollowUpService = () => {
  ...
  const content = {
    ...
    ar: {
      title: "متابعة الحمل",
      subtitle: "التقييم والمراقبة المنتظمة أثناء الحمل",
      description: "متابعة الحمل هي عملية لضمان صحة الأم والطفل خلال الحمل. في فيرتينا IVF، نقدم رعاية الحمل بأحدث الطرق الطبية تحت إشراف متخصصينا ذوي الخبرة.",
      firstTrimester: {title: "الثلث الأول (0-12 أسبوعًا)", items: ["الزيارة الأولى (6-8 أسابيع): يتم تأكيد الحمل بالموجات فوق الصوتية؛ يُرى نبض القلب", "فحوصات الدم والبول: فصيلة الدم، فحص العدوى، فحوصات الغدة الدرقية", "اختبارات الفحص: قياس NT والاختبار المشترك (11-14 أسبوعًا)", "نمط الحياة: حمض الفوليك، الفيتامينات وإرشادات التغذية"]},
      secondTrimester: {title: "الثلث الثاني (13-24 أسبوعًا)", items: ["الفحوصات الشهرية وتتبع النمو", "اختبار ثلاثي/رباعي (16-20 أسبوعًا)", "فحص الشذوذ التفصيلي (20-22 أسبوعًا)", "فحص الجلوكوز (24-28 أسبوعًا)", "تقييم صحة الأم ومخاطر الولادة المبكرة"]},
      thirdTrimester: {title: "الثلث الثالث (25-40 أسبوعًا)", items: ["زيارات كل أسبوعين ثم أسبوعية؛ نمو الجنين، تقييم السوائل والمشيمة", "مراقبة NST بعد 32 أسبوعًا", "عدد خلايا الدم ومستويات الحديد", "تخطيط الولادة (مهبلي مقابل قيصري)", "زيارات أسبوعية بعد 37 أسبوعًا حتى الولادة"]},
      benefitsTitle: "الفوائد",
      benefits: ["الكشف المبكر عن المشكلات المحتملة في الطفل", "المراقبة الدقيقة لصحة الأم والمخاطر", "تخطيط عملية ولادة آمنة"],
      screeningTitle: "اختبارات الفحص أثناء الحمل",
      screeningIntro: "توفر اختبارات الفحص معلومات مبكرة عن صحة الطفل وهي حاسمة في التشخيص المبكر للتشوهات الخلقية.",
      nipd: {title: "NIPD", desc: "أكثر الفحوصات موثوقية؛ بعد 10 أسابيع؛ تحلل الحمض النووي للجنين من دم الأم؛ ~99% موثوقية."},
      duo: {title: "الاختبار المشترك (11-14 أسبوعًا)", desc: "علامات المصل بالإضافة إلى سماكة الشفافية القفوية لتقييم خطر التثلث الصبغي."},
      quad: {title: "اختبار رباعي (16-19 أسبوعًا)", desc: "قياسات AFP، HCG، Estriol لخطر التثلث الصبغي وعيب الأنبوب العصبي."},
      usDetail: {title: "الموجات فوق الصوتية التفصيلية", desc: "فحص شامل رباعي الأبعاد في 18-22 أسبوعًا؛ ~45-60 دقيقة؛ ~80% موثوقية."},
      whyTitle: "لماذا تعتبر اختبارات الفحص مهمة؟",
      why: ["توفر رؤية مبكرة لصحة الطفل", "تمكن التشخيص المبكر للحالات عالية الخطورة", "تسمح بالاختبارات المتقدمة في الوقت المناسب وتخطيط العلاج"],
      closing: "في فيرتينا IVF، يتم إجراء متابعة الحمل بأحدث الطرق الطبية من قبل متخصصينا ذوي الخبرة. نحن معك في كل مرحلة من أجل صحتك وصحة طفلك.",
      cta: "احجز موعد",
