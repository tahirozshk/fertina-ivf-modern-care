...
const TestimonialsSection = ({ language }: TestimonialsSectionProps) => {
  ...
  const content = {
    ...
    ar: {
      title: "شهادات المرضى",
      subtitle: "تجارب من عائلاتنا السعيدة",
      testimonials: [
        {
          name: "عائشة ومحمد ك.",
          location: "إسطنبول، تركيا",
          text: "بعد 3 سنوات صعبة، حققنا حلمنا في فيرتينا IVF. شكرًا لكم على النهج المهني والمعلومات التفصيلية والاهتمام الصادق.",
          rating: 5,
        },
        {
          name: "سارة وجون م.",
          location: "لندن، المملكة المتحدة",
          text: "جعل فريق فيرتينا IVF رحلتنا أسهل بكثير. من الاستشارة الأولى إلى العلاج الناجح، تم التعامل مع كل شيء بعناية وخبرة.",
          rating: 5,
        },
        {
          name: "إليف وجان ي.",
          location: "أنقرة، تركيا",
          text: "التقينا بطفلنا بفضل برنامج التبرع بالبويضات. القدوم إلى قبرص كان القرار الصحيح. كانت خبرة الفريق والبنية التحتية التكنولوجية مذهلة.",
          rating: 5,
        },
      ],
    },
